...
echo html_writer::select($options_opt, "minoptionalcourses", $grade->minoptionalcourses, false);

echo html_writer::empty_tag('br');
echo html_writer::tag('B', get_string('maxoptionalcourses', 'local_grade_curricular'));
echo html_writer::select($options_opt, "maxoptionalcourses", $grade->maxoptionalcourses, false);
...
echo html_writer::select($yesno_options, "optionalatonetime", $grade->optionalatonetime, false);
